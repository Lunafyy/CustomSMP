...
public abstract class Airdrop {
    ...
    public static ChatColor inventoryTitleColour() throws StaticMethodNotImplementedException {
        throw new StaticMethodNotImplementedException("Airdrop inventory title colour must be defined for custom airdrops.");
    }
}
